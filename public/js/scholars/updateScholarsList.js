            ...
            if(List.length > 0){
                        ...
                        <div class="card-header bg-transparent border-bottom d-flex justify-content-between">
                            ...
                            <div class="dropdown text-end">
                                ...
                                <ul class="dropdown-menu dropdown-w-sm dropdown-menu-end min-w-auto shadow rounded" aria-labelledby="dropdownShare2">
                                    ...
                                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#removeScholar"><i class="bi bi-trash fa-fw me-2"></i>Remove</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card-footer bg-transparent border-top">
                            <div class="d-sm-flex justify-content-between align-items-center">
                                ...
                                <div class="text-end text-primary-hover">
                                    ...
                                    <a href="#" class="btn btn-link text-body p-0 mb-0" data-bs-placement="top" title="" data-bs-original-title="Block" aria-label="Block" data-bs-toggle="modal" data-bs-target="#blockScholar">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-light btn-round mb-0" data-bs-toggle="modal" data-bs-target="#blockScholar">
                            <i class="fas fa-ban"></i>
                        </button>
                    </td>
                </tr>`
